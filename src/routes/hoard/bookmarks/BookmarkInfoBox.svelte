...
<div class='block w-full h-full bg-gray-900 bg-opacity-80 rounded-lg border-2 border-gray-700 p-4'>
    ...
    >
        <info class='flex flex-col gap-y-4 px-4 pt-4'>
            ...
            <a draggable={true} href={item.data.data.data.url} class='block w-full text-gray-300 text-sm py-2 px-3 text-center bg-gray-400 bg-opacity-20 rounded-xl break-words'>
